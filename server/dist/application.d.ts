...
declare const StripeIntegrationApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class StripeIntegrationApplication extends StripeIntegrationApplication_base {
